(() => {
      ...
      for (let n = 0; n < p; n += 1) {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            (y = (r - (i.slidesPerView - 1) * T) / i.slidesPerView),
              i.roundLengths && (y = Math.floor(y)),
      ...
      if (
        ...
        if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!r.support.smoothScroll)
            return (
              b({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, n) {
      ...
      if (a.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!r.support.smoothScroll)
            return (
              b({ swiper: r, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function z(e) {
    ...
    if (
      ...
      let e = !0;
      p.is(o.focusableElements) &&
        ((e = !1), "SELECT" === p[0].nodeName && (o.isTouched = !1)),
        s.activeElement &&
  ...
  let ee = document.querySelector(".manu-list__name"),
    te = document.querySelector(".manu-list__items"),
    se = document.querySelector(".manu-list__name");
  ee.addEventListener("click", function () {
    te.classList.toggle("manu-hover"), se.classList.toggle("manu-up");
  });
  let ie = document.querySelector(".arow"),
    ne = document.querySelector(".started-column");
  window.addEventListener("scroll", function () {
    let e = window.scrollY;
    e > 800 ? ie.classList.add("arre-an") : ie.classList.remove("arre-an"),
      e > 1532
        ? ne.classList.add("column-trans")
        : ne.classList.remove("column-trans");
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
